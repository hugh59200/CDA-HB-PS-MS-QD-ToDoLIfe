  ...
  return (
    ...
    <div className="container-fluid ">
      <div className="row justify-content-center">
        ...
        <button className="m-2 col-2 col-md-2 col-lg-2 btn btn-test2">LIVRES</button>
      </div>
        ...
        <div className="col-12 col-md-6 col-lg-6 bloc-film">
          ...
          <div className="ajout-film row">
            ...
            <div className="icone-suppr-edit col-6">
              <button className="boutton-modifier" onClick={() => { history.push(URL_NEW_LIVRE) }}  >   </button>
              <button className="boutton-supprimer" onClick={() => { history.push(URL_NEW_LIVRE) }}  >   </button>
            </div>
          </div>
        </div>
      </div>
