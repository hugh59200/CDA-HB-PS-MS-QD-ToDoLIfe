...
export function selectAnnee(fetchUrl, annee, setshowList, mois, allyear) {
	return (
		<select
		className="form-select"
		onChange={e => {
			fetchUrl(e.target.value, mois);
				setshowList(true);
			}}
			>
...
export function selectMois(fetchUrl, mois, setshowList, annee, allmonth) {
	return (
		<select
			className="form-select"
			onChange={e => {
				fetchUrl(annee, e.target.value);
				setshowList(true);
			}}
		>
