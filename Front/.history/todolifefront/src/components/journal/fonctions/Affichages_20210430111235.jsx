	...
	return (
		<>
			<div className="creationJour">
				...
				<div className="choixMood" onClick={(e) => imageClick(e)}>
					<img src={mood4} alt="Logo" value="1" className="mood" />
					<img src={mood3} alt="Logo" value="2" className="mood" />
					<img src={mood2} alt="Logo" value="3" className="mood" />
					<img src={mood1} alt="Logo" value="4" className="mood" />
				</div>
