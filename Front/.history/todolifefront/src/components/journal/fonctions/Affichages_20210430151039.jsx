...
import { bouttonAjouter, bouttonRevenir } from './Bouttons';
...
export function ajouterJour(setshowList, setshowJourDetail, settitre, setmoodInt, setresume ) {
	return (
		<>
			...
			{bouttonAjouter(setshowList, setshowJourDetail)}
