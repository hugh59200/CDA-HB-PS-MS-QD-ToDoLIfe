	...
	return (
		<>
			<div className="entete">
				{selectMois(fetchUrl, mois, setshowList, annee, allmonth)}
				{selectAnnee(fetchUrl, annee, setshowList, mois, allyear)}
			</div>
		</>
	);
}
...
export function selectMois(fetchUrl, annee, setshowList, annee, allmonth) {
...
export function selectAnnee(fetchUrl, mois, setshowList, mois, allyear) {
	return (
		<select
			className="form-select"
			onChange={e => {
